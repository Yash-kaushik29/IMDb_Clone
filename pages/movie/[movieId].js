  ...
  return (
    <>
      ...
      >
        ...
        <animated.div className="fixed bottom-4 sm:bottom-10 right-4 sm:right-10 text-xl sm:text-2xl animate-bounce cursor-pointer " style={{ opacity: scrollYProgress }}>
          <FaArrowUp className="text-amber-500 dark:text-pink-700 bg-gray-100 rounded-full" onClick={scrollToTop} />
        </animated.div>
        <div className="flex flex-col md:flex-row justify-center items-center mx-2 sm:mx-10 my-2 w-full md:w-[90%] lg:w-[70%]">
          ...
          <div className="flex flex-col px-6 items-center md:items-start text-center md:text-start">
            ...
            <div className="flex items-center my-2 text-white font-semibold text-sm sm:text-base">
              {" "}
              Watch trailer on{" "}
              <TbBrandYoutubeFilled className="mx-2 text-3xl text-red-600" />
            </div>
